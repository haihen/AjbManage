...
public class SmsUtils {
	...
	//短信账号
	private static final String ACCESSKEYID = "LTAII5smTNEch7DN";
	//短信密码
	private static final String ACCESSSECRET = "aBXhtxADw7HcBfu4RkuidMAnJnToFI";
	//区域ID
	private static final String REGIONID = "cn-hangzhou";
	//短信签名
	private static final String SIGNNAME = "西青全民学习网";
	//短信模板CODE
	private static final String TEMPLATECODE = "SMS_164670035";
