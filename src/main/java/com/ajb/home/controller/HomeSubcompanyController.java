...
@Controller
@RequestMapping("/system/home/subcompany")
public class HomeSubcompanyController {
	@Autowired
	...
	@GetMapping()
	@RequiresPermissions("system:home:subcompany")
	String Home(){
	    return "system/home/subcompany/subcompany";
	}
	...
	@GetMapping("/add")
	@RequiresPermissions("system:home:addsubcompany")
	String add(){
	    return "system/home/subcompany/add";
	}

	@GetMapping("/edit/{id}")
	@RequiresPermissions("system:home:editsubcompany")
	String edit(@PathVariable("id") Integer id,Model model){
		HomeDO home = homeService.get(id);
		model.addAttribute("subcompany", home);
	    return "system/home/subcompany/edit";
	}
	...
	public R save(@RequestParam("imageFile") MultipartFile imageFile,HomeDO home){
		...
		if(imageFile!=null && !imageFile.isEmpty()){
			...
			fileUrl =FileUtil.reUrl("homeSubcompanyImg");
			try {
	...
	@PostMapping( "/remove")
	@ResponseBody
	@RequiresPermissions("system:home:removesubcompany")
